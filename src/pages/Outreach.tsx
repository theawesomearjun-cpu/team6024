        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground animate-fade-in-up" style={{ animationDelay: "200ms" }}>
              As India's first FRC team, we've embraced a mission that goes far beyond competition - spreading STEM education, nurturing new teams, and building a robotics ecosystem across the nation.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              { value: "5+", label: "Regionals Hosted" },
