      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="max-w-4xl mx-auto">
            <p className="font-orbitron text-primary uppercase tracking-[0.3em] text-sm md:text-base mb-4 animate-fade-in-up" style={{
            animationDelay: "0ms"
          }}>
              FRC Team 6024
            </p>
            <h1 className="font-orbitron font-bold text-5xl md:text-7xl lg:text-8xl text-foreground mb-6 animate-fade-in-up" style={{
            animationDelay: "100ms"
          }}>
              <span className="text-gradient">R-FACTOR</span>
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground mb-4 animate-fade-in-up" style={{
            animationDelay: "200ms"
          }}>Winning Hearts with Winning Efforts</p>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10 animate-fade-in-up" style={{
            animationDelay: "300ms"
          }}>India's first team in the competition, inspiring innovation, engineering excellence, and the spirit of gracious professionalism across the nation.</p>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {values.map((value, index) => <div key={value.title} className="text-center p-8 rounded-lg bg-card border border-border hover:border-primary/50 transition-all duration-300 group animate-fade-in-up" style={{
            animationDelay: `${index * 100}ms`
          }}>
      ...
      <section className="py-24 bg-card">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {sections.map(section => <Link key={section.title} to={section.link} className="group relative p-8 rounded-xl bg-gradient-card border border-border hover:border-primary/50 transition-all duration-300 overflow-hidden animate-fade-in-up" style={{
      ...
      <section className="py-24 bg-background relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-orbitron font-bold text-3xl md:text-4xl text-foreground mb-6">Ready to join?<span className="text-gradient">Revolution?</span>
            </h2>
