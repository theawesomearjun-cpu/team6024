...
const competitions = [
  {
    year: "2024",
    events: [
      { name: "Regional Event", location: "Location TBD", status: "Upcoming", result: "" },
    ],
  },
  {
    year: "2023",
    events: [
      { name: "FRC Regional", location: "International", status: "Completed", result: "Participated" },
    ],
  },
  {
    year: "2022",
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              { value: "10+", label: "Regionals" },
              { value: "5+", label: "Awards" },
              { value: "1", label: "World Championship" },
            ].map((stat, index) => (
